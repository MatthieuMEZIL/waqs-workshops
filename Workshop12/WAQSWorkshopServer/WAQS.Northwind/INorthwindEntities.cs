...
namespace WAQSWorkshopServer.DAL.Interfaces
{
    public partial interface INorthwindEntities : IObjectContext, IDisposable
    {
        ...
        ICustomerDALSpecifications CustomerDALSpecifications { get; }
        IEmployeeDALSpecifications EmployeeDALSpecifications { get; }
        IOrderDetailDALSpecifications OrderDetailDALSpecifications { get; }
        IOrderDALSpecifications OrderDALSpecifications { get; }
        IProductDALSpecifications ProductDALSpecifications { get; }
