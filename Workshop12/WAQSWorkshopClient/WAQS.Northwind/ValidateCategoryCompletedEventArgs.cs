...
namespace WAQSWorkshopClient.ClientContext.ServiceReference
{
    ...
    public partial class ValidateCategoryCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        public ValidateCategoryCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState): base (exception, cancelled, userState)
        {
