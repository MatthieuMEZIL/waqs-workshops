...
#region Simple Properties
        ...
        protected virtual Error ValidateRegionRequired(string value)
        {
            ...
            if (error == null)
                Errors.Region.Add(error = new Error{Criticity = Criticity.Mandatory, Key = "RegionRequired", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
        ...
        protected virtual Error ValidatePostalCodePattern(string value)
        {
            ...
            if (error == null)
                Errors.PostalCode.Add(error = new Error{Criticity = Criticity.Error, Key = "PostalCodePattern", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
