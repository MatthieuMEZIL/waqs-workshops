    ...
    public partial class NorthwindClientContext : NorthwindClientContextBase, INorthwindClientContext, IClientContext
    {
        ...
        public void RefreshNewLoadedProperties(WAQSWorkshopClient.Customer entityInCache, WAQSWorkshopClient.Customer entity, bool applyState = false)
        {
            ...
            if (entity.Specifications != null)
            {
                ...
                {
                    if (! entityInCache.Specifications.HasTotalSpent && entity.Specifications.HasTotalSpent)
                    {
                        entityInCache.Specifications.TotalSpent = entity.Specifications.TotalSpent;
                        entityInCache.Specifications.HasTotalSpent = entity.Specifications.HasTotalSpent;
                    }
                    if (! entityInCache.Specifications.HasFullName && entity.Specifications.HasFullName)
                    {
                        entityInCache.Specifications.FullName = entity.Specifications.FullName;
                        entityInCache.Specifications.HasFullName = entity.Specifications.HasFullName;
                    }
                }
            }
            entityInCache.IsDeserializing = isDeserializing;
    	...
    	private void InternalRefreshCurrentValues(WAQSWorkshopClient.Customer entityInCache, WAQSWorkshopClient.Customer entity)
    	{
            ...
            if (entity.Specifications != null)
            {
                ...
                {
                    if (entity.Specifications.HasTotalSpent)
                    {
                        entityInCache.Specifications.TotalSpent = entity.Specifications.TotalSpent;
                        entityInCache.Specifications.HasTotalSpent = entity.Specifications.HasTotalSpent;
                    }
                    if (entity.Specifications.HasFullName)
                    {
                        entityInCache.Specifications.FullName = entity.Specifications.FullName;
                        entityInCache.Specifications.HasFullName = entity.Specifications.HasFullName;
                    }
        ...
        public void RefreshNewLoadedProperties(WAQSWorkshopClient.Order entityInCache, WAQSWorkshopClient.Order entity, bool applyState = false)
        {
            ...
            if (entity.Specifications != null)
            {
                ...
                {
                    if (! entityInCache.Specifications.HasTotal && entity.Specifications.HasTotal)
                    {
                        entityInCache.Specifications.Total = entity.Specifications.Total;
                        entityInCache.Specifications.HasTotal = entity.Specifications.HasTotal;
                    }
                    if (! entityInCache.Specifications.HasCustomerCompanyName && entity.Specifications.HasCustomerCompanyName)
                    {
                        entityInCache.Specifications.CustomerCompanyName = entity.Specifications.CustomerCompanyName;
                        entityInCache.Specifications.HasCustomerCompanyName = entity.Specifications.HasCustomerCompanyName;
                    }
                    if (! entityInCache.Specifications.HasCustomerContactName && entity.Specifications.HasCustomerContactName)
                    {
                        entityInCache.Specifications.CustomerContactName = entity.Specifications.CustomerContactName;
                        entityInCache.Specifications.HasCustomerContactName = entity.Specifications.HasCustomerContactName;
                    }
                    if (! entityInCache.Specifications.HasHasInvoice && entity.Specifications.HasHasInvoice)
                    {
                        entityInCache.Specifications.HasInvoice = entity.Specifications.HasInvoice;
                        entityInCache.Specifications.HasHasInvoice = entity.Specifications.HasHasInvoice;
                    }
                }
            }
            entityInCache.IsDeserializing = isDeserializing;
    	...
    	private void InternalRefreshCurrentValues(WAQSWorkshopClient.Order entityInCache, WAQSWorkshopClient.Order entity)
    	{
            ...
            if (entity.Specifications != null)
            {
                ...
                {
                    if (entity.Specifications.HasTotal)
                    {
                        entityInCache.Specifications.Total = entity.Specifications.Total;
                        entityInCache.Specifications.HasTotal = entity.Specifications.HasTotal;
                    }
                    if (entity.Specifications.HasCustomerCompanyName)
                    {
                        entityInCache.Specifications.CustomerCompanyName = entity.Specifications.CustomerCompanyName;
                        entityInCache.Specifications.HasCustomerCompanyName = entity.Specifications.HasCustomerCompanyName;
                    }
                    if (entity.Specifications.HasCustomerContactName)
                    {
                        entityInCache.Specifications.CustomerContactName = entity.Specifications.CustomerContactName;
                        entityInCache.Specifications.HasCustomerContactName = entity.Specifications.HasCustomerContactName;
                    }
                    if (entity.Specifications.HasHasInvoice)
                    {
                        entityInCache.Specifications.HasInvoice = entity.Specifications.HasInvoice;
                        entityInCache.Specifications.HasHasInvoice = entity.Specifications.HasHasInvoice;
                    }
        ...
        public void RefreshNewLoadedProperties(WAQSWorkshopClient.OrderDetail entityInCache, WAQSWorkshopClient.OrderDetail entity, bool applyState = false)
        {
            ...
            if (entity.Specifications != null)
            {
                ...
                {
                    if (! entityInCache.Specifications.HasAmount && entity.Specifications.HasAmount)
                    {
                        entityInCache.Specifications.Amount = entity.Specifications.Amount;
                        entityInCache.Specifications.HasAmount = entity.Specifications.HasAmount;
                    }
                    if (! entityInCache.Specifications.HasProductFullName && entity.Specifications.HasProductFullName)
                    {
                        entityInCache.Specifications.ProductFullName = entity.Specifications.ProductFullName;
                        entityInCache.Specifications.HasProductFullName = entity.Specifications.HasProductFullName;
                    }
                }
            }
            entityInCache.IsDeserializing = isDeserializing;
    	...
    	private void InternalRefreshCurrentValues(WAQSWorkshopClient.OrderDetail entityInCache, WAQSWorkshopClient.OrderDetail entity)
    	{
            ...
            if (entity.Specifications != null)
            {
                ...
                {
                    if (entity.Specifications.HasAmount)
                    {
                        entityInCache.Specifications.Amount = entity.Specifications.Amount;
                        entityInCache.Specifications.HasAmount = entity.Specifications.HasAmount;
                    }
                    if (entity.Specifications.HasProductFullName)
                    {
                        entityInCache.Specifications.ProductFullName = entity.Specifications.ProductFullName;
                        entityInCache.Specifications.HasProductFullName = entity.Specifications.HasProductFullName;
                    }
        ...
        protected override WAQSWorkshopClient.DTO.CustomerInfo GetDTO(WAQSWorkshopClient.DTO.CustomerInfo dto, List<WAQSWorkshopClient.DTO.CustomerInfo> attachedDtosCustomerInfo, List<WAQSWorkshopClient.DTO.LastOrderDTO> attachedDtosLastOrderDTO, MergeOption? mergeOption = null, bool applyDataTransfer = false)
        {
            return GetDTO(dto, attachedDtosCustomerInfo, attachedDtosLastOrderDTO, false, mergeOption, ObjectState.Unchanged, applyDataTransfer);
        }
        private WAQSWorkshopClient.DTO.CustomerInfo GetDTO(WAQSWorkshopClient.DTO.CustomerInfo dto, bool applyState, MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, bool applyDataTransfer = false)
        {
            return GetDTO(dto, new List<WAQSWorkshopClient.DTO.CustomerInfo>(), new List<WAQSWorkshopClient.DTO.LastOrderDTO>(), applyState, mergeOption, defaultState, applyDataTransfer);
        }
        private WAQSWorkshopClient.DTO.CustomerInfo GetDTO(WAQSWorkshopClient.DTO.CustomerInfo dto, List<WAQSWorkshopClient.DTO.CustomerInfo> attachedDtosCustomerInfo, List<WAQSWorkshopClient.DTO.LastOrderDTO> attachedDtosLastOrderDTO, bool applyState, MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, bool applyDataTransfer = false)
        {
            if (dto == null)
                return null;
            if (attachedDtosCustomerInfo.Contains(dto))
                return dto;
            attachedDtosCustomerInfo.Add(dto);
            return dto;
        }
    
        protected override WAQSWorkshopClient.DTO.LastOrderDTO GetDTO(WAQSWorkshopClient.DTO.LastOrderDTO dto, List<WAQSWorkshopClient.DTO.CustomerInfo> attachedDtosCustomerInfo, List<WAQSWorkshopClient.DTO.LastOrderDTO> attachedDtosLastOrderDTO, MergeOption? mergeOption = null, bool applyDataTransfer = false)
        {
            return GetDTO(dto, attachedDtosCustomerInfo, attachedDtosLastOrderDTO, false, mergeOption, ObjectState.Unchanged, applyDataTransfer);
        }
        private WAQSWorkshopClient.DTO.LastOrderDTO GetDTO(WAQSWorkshopClient.DTO.LastOrderDTO dto, bool applyState, MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, bool applyDataTransfer = false)
        {
            return GetDTO(dto, new List<WAQSWorkshopClient.DTO.CustomerInfo>(), new List<WAQSWorkshopClient.DTO.LastOrderDTO>(), applyState, mergeOption, defaultState, applyDataTransfer);
        }
        private WAQSWorkshopClient.DTO.LastOrderDTO GetDTO(WAQSWorkshopClient.DTO.LastOrderDTO dto, List<WAQSWorkshopClient.DTO.CustomerInfo> attachedDtosCustomerInfo, List<WAQSWorkshopClient.DTO.LastOrderDTO> attachedDtosLastOrderDTO, bool applyState, MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, bool applyDataTransfer = false)
        {
            if (dto == null)
                return null;
            if (attachedDtosLastOrderDTO.Contains(dto))
                return dto;
            attachedDtosLastOrderDTO.Add(dto);
            return dto;
        }
        ...
        public async Task<WAQSWorkshopClient.Invoice> AddInvoiceAsync(int orderId, MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, Func<bool> cancel = null)
        {
            try
            {
                var value = await ProxyHelper.ExecuteFuncAsync(ServiceFactory, service => Task.Factory.FromAsync(service.BeginAddInvoice(orderId, null, null), ar => service.EndAddInvoice(ar)), 0);
                if (IsDisposed)
                    return value;
                ...
                try
                {
                    return GetEntity(value, true, mergeOption, defaultState: defaultState, applyDataTransfer: true);
                }
                finally
                {
                    Init = false;
            ...
            {
                if (IsDisposed)
                    return default(WAQSWorkshopClient.Invoice);
                throw ServerException.Throw(e.Detail.ErrorType, e.Detail.ErrorMessage); // throw for compiler
            }
            catch(Exception e)
            {
                if (IsDisposed)
                    return default(WAQSWorkshopClient.Invoice);
                bool catched = false;
                WAQSWorkshopClient.Invoice result = default(WAQSWorkshopClient.Invoice);
                AddInvoiceAsyncCatchException(e, ref catched, ref result);
                if (catched)
                    return result;
                CatchException(e, ref catched);
                if (catched)
        ...
        partial void AddInvoiceAsyncCatchException(Exception e, ref bool catched, ref WAQSWorkshopClient.Invoice result);
        
        public async Task<WAQSWorkshopClient.InvoiceDetail> CreateInvoiceDetailAsync(OrderDetail od, MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, Func<bool> cancel = null)
        {
            try
            {
                var value = await ProxyHelper.ExecuteFuncAsync(ServiceFactory, service => Task.Factory.FromAsync(service.BeginCreateInvoiceDetail(od, null, null), ar => service.EndCreateInvoiceDetail(ar)), 0);
                if (IsDisposed)
                    return value;
                if (cancel != null && cancel())
                    return null;
            ...
            {
                if (IsDisposed)
                    return default(WAQSWorkshopClient.InvoiceDetail);
                throw ServerException.Throw(e.Detail.ErrorType, e.Detail.ErrorMessage); // throw for compiler
            }
            catch(Exception e)
            {
                if (IsDisposed)
                    return default(WAQSWorkshopClient.InvoiceDetail);
                bool catched = false;
                WAQSWorkshopClient.InvoiceDetail result = default(WAQSWorkshopClient.InvoiceDetail);
                CreateInvoiceDetailAsyncCatchException(e, ref catched, ref result);
                if (catched)
                    return result;
                CatchException(e, ref catched);
                if (catched)
        ...
        partial void CreateInvoiceDetailAsyncCatchException(Exception e, ref bool catched, ref WAQSWorkshopClient.InvoiceDetail result);
        
        public async Task<WAQSWorkshopClient.DTO.LastOrderDTO> GetLastOrderAsync(MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, Func<bool> cancel = null)
        {
            try
            {
                var value = await ProxyHelper.ExecuteFuncAsync(ServiceFactory, service => Task.Factory.FromAsync(service.BeginGetLastOrder(null, null), ar => service.EndGetLastOrder(ar)), 0);
                if (IsDisposed)
                    return value;
                if (cancel != null && cancel())
                    return null;
                ...
                try
                {
                    return GetDTO(value, true, mergeOption, defaultState: defaultState, applyDataTransfer: true);
                }
                finally
                {
                    Init = false;
            ...
            {
                if (IsDisposed)
                    return default(WAQSWorkshopClient.DTO.LastOrderDTO);
                throw ServerException.Throw(e.Detail.ErrorType, e.Detail.ErrorMessage); // throw for compiler
            }
            catch(Exception e)
            {
                if (IsDisposed)
                    return default(WAQSWorkshopClient.DTO.LastOrderDTO);
                bool catched = false;
                WAQSWorkshopClient.DTO.LastOrderDTO result = default(WAQSWorkshopClient.DTO.LastOrderDTO);
                GetLastOrderAsyncCatchException(e, ref catched, ref result);
                if (catched)
                    return result;
                CatchException(e, ref catched);
                if (catched)
        ...
        partial void GetLastOrderAsyncCatchException(Exception e, ref bool catched, ref WAQSWorkshopClient.DTO.LastOrderDTO result);
