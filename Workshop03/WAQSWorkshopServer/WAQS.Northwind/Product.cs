    ...
    #region Navigation Properties
        ...
        public Category Category
        {
            ...
            set
            {
                ...
                if (!(IsDeserializing || ChangeTracker.State == ObjectState.Added || ChangeTracker.ObjectsRemovedFromCollectionProperties.ContainsKey("Category")))
                    ChangeTracker.RecordRemovalFromCollectionProperties("Category", previousValue);
                _category = value;
        ...
        private void FixupCategory(Category previousValue, bool skipKeys = false)
        {
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                ...
                if (Category != null && !Category.ChangeTracker.ChangeTrackingEnabled)
                    Category.ChangeTracker.ChangeTrackingEnabled = true;
            }
        }
