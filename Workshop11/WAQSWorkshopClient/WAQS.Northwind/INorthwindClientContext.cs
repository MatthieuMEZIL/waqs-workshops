...
namespace WAQSWorkshopClient.ClientContext.Interfaces
{
    public partial interface INorthwindClientContext : IClientContext<INorthwindClientContext>
    {
        ...
        Task<WAQSWorkshopClient.DTO.LastOrderDTO> GetLastOrderAsync(MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, Func<bool> cancel = null);
