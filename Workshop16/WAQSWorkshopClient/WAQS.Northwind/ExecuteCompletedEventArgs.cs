...
namespace WAQSWorkshopClient.ClientContext.ServiceReference
{
    ...
    public partial class ExecuteCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        public ExecuteCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState): base (exception, cancelled, userState)
        {
            this.results = results;
        }

        public WAQSWorkshopClient.ClientContext.QueryResult.NorthwindQueryResult Result
        {
            get
            {
                base.RaiseExceptionIfNecessary();
                return ((WAQSWorkshopClient.ClientContext.QueryResult.NorthwindQueryResult)(this.results[0]));
            }
        }
    }
}
