...
namespace WAQSWorkshopClient.ClientContext.ServiceReference
{
    ...
    public partial class SaveChangesCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        public SaveChangesCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState): base (exception, cancelled, userState)
        {
            this.results = results;
        }

        public WAQSWorkshopClient.ClientContext.Interfaces.Serialization.NorthwindSerializableContext Result
        {
            get
            {
                base.RaiseExceptionIfNecessary();
                return ((WAQSWorkshopClient.ClientContext.Interfaces.Serialization.NorthwindSerializableContext)(this.results[0]));
            }
        }
    }
}
