...
namespace WAQSWorkshopClient.ClientContext.ServiceReference
{
    ...
    public partial class CreateInvoiceDetailCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        private object[] results;
        public CreateInvoiceDetailCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState): base (exception, cancelled, userState)
        {
            this.results = results;
        }

        public WAQSWorkshopClient.InvoiceDetail Result
        {
            get
            {
                base.RaiseExceptionIfNecessary();
                return ((WAQSWorkshopClient.InvoiceDetail)(this.results[0]));
            }
        }
    }
}
