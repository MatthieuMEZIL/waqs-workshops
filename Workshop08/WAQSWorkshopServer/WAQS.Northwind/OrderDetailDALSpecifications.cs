...
namespace WAQSWorkshopServer.DAL
{
    public partial class OrderDetailDALSpecifications : IOrderDetailDALSpecifications
    {
        ...
        Expression<Func<WAQSWorkshopServer.OrderDetail, InvoiceDetail>> IOrderDetailDALSpecifications.CreateInvoiceDetailExpression
        {
            get { return OrderDetailDALSpecifications.GetCreateInvoiceDetailExpression(); }
        }
    
        private static Expression<Func<WAQSWorkshopServer.OrderDetail, InvoiceDetail>> _getCreateInvoiceDetailExpression;
        protected internal static Expression<Func<WAQSWorkshopServer.OrderDetail, InvoiceDetail>> GetCreateInvoiceDetailExpression(bool isCoalesceEnabled = true)
        {
        ...
        OrderDetailId = od.Id, Quantity = od.Quantity, UnitPrice = od.UnitPrice, Discount = od.Discount, Amount = getAmount_OrderDetail(od)};
                ...
                exp = (Expression<Func<WAQSWorkshopServer.OrderDetail, InvoiceDetail>>)exp.ReplaceInvocation(replaceExpFunc);
                _getCreateInvoiceDetailExpression = exp;
            }
            GetCreateInvoiceDetailExpression(ref _getCreateInvoiceDetailExpression);
            return _getCreateInvoiceDetailExpression;
        }
        static partial void GetCreateInvoiceDetailExpression(ref Expression<Func<WAQSWorkshopServer.OrderDetail, InvoiceDetail>> exp);
