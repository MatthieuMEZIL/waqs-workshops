...
namespace WAQSWorkshopClient.ClientContext.ServiceReference
{
    ...
    public partial class GetLastOrderCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {
        ...
        public GetLastOrderCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState): base (exception, cancelled, userState)
        {
            this.results = results;
        }

        public WAQSWorkshopClient.DTO.LastOrderDTO Result
        {
            get
            {
                base.RaiseExceptionIfNecessary();
                return ((WAQSWorkshopClient.DTO.LastOrderDTO)(this.results[0]));
            }
        }
    }
}
