...
namespace WAQSWorkshopClient.ClientContext.ServiceReference
{
    ...
    public partial class NorthwindServiceClient : System.ServiceModel.ClientBase<WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService>, WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService
    {
        ...
        private BeginOperationDelegate onBeginValidateCategoryDelegate;
        private EndOperationDelegate onEndValidateCategoryDelegate;
        private System.Threading.SendOrPostCallback onValidateCategoryCompletedDelegate;
        private BeginOperationDelegate onBeginAlreadySoldToDelegate;
        private EndOperationDelegate onEndAlreadySoldToDelegate;
        private System.Threading.SendOrPostCallback onAlreadySoldToCompletedDelegate;
        private BeginOperationDelegate onBeginAddInvoiceDelegate;
        private EndOperationDelegate onEndAddInvoiceDelegate;
        private System.Threading.SendOrPostCallback onAddInvoiceCompletedDelegate;
        private BeginOperationDelegate onBeginCreateInvoiceDetailDelegate;
        private EndOperationDelegate onEndCreateInvoiceDetailDelegate;
        private System.Threading.SendOrPostCallback onCreateInvoiceDetailCompletedDelegate;
        private BeginOperationDelegate onBeginGetLastOrderDelegate;
        private EndOperationDelegate onEndGetLastOrderDelegate;
        private System.Threading.SendOrPostCallback onGetLastOrderCompletedDelegate;
        ...
        public event System.EventHandler<ValidateCategoryCompletedEventArgs> ValidateCategoryCompleted;
        public event System.EventHandler<AlreadySoldToCompletedEventArgs> AlreadySoldToCompleted;
        public event System.EventHandler<AddInvoiceCompletedEventArgs> AddInvoiceCompleted;
        public event System.EventHandler<CreateInvoiceDetailCompletedEventArgs> CreateInvoiceDetailCompleted;
        public event System.EventHandler<GetLastOrderCompletedEventArgs> GetLastOrderCompleted;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.BeginValidateCategory(WAQSWorkshopClient.Category entity, System.AsyncCallback callback, object asyncState)
        {
            return base.Channel.BeginValidateCategory(entity, callback, asyncState);
        }

        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WAQS.ClientContext.Interfaces.Errors.Error[] WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.EndValidateCategory(System.IAsyncResult result)
        {
            return base.Channel.EndValidateCategory(result);
        }

        private System.IAsyncResult OnBeginValidateCategory(object[] inValues, System.AsyncCallback callback, object asyncState)
        {
            WAQSWorkshopClient.Category entity = ((WAQSWorkshopClient.Category)(inValues[0]));
            return ((WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService)(this)).BeginValidateCategory(entity, callback, asyncState);
        }
        ...
        private void OnValidateCategoryCompleted(object state)
        {
            ...
            {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.ValidateCategoryCompleted(this, new ValidateCategoryCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }

        public void ValidateCategoryAsync(WAQSWorkshopClient.Category entity)
        {
            this.ValidateCategoryAsync(entity, null);
        }

        public void ValidateCategoryAsync(WAQSWorkshopClient.Category entity, object userState)
        {
            if ((this.onBeginValidateCategoryDelegate == null))
            {
                this.onBeginValidateCategoryDelegate = new BeginOperationDelegate(this.OnBeginValidateCategory);
            }

            if ((this.onEndValidateCategoryDelegate == null))
            {
                this.onEndValidateCategoryDelegate = new EndOperationDelegate(this.OnEndValidateCategory);
            }

            if ((this.onValidateCategoryCompletedDelegate == null))
            {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.BeginAlreadySoldTo(WAQSWorkshopClient.Employee employee, WAQSWorkshopClient.Customer customer, System.AsyncCallback callback, object asyncState)
        {
            return base.Channel.BeginAlreadySoldTo(employee, customer, callback, asyncState);
        }

        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        bool WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.EndAlreadySoldTo(System.IAsyncResult result)
        {
            return base.Channel.EndAlreadySoldTo(result);
        }

        private System.IAsyncResult OnBeginAlreadySoldTo(object[] inValues, System.AsyncCallback callback, object asyncState)
        {
            WAQSWorkshopClient.Employee employee = ((WAQSWorkshopClient.Employee)(inValues[0]));
            WAQSWorkshopClient.Customer customer = ((WAQSWorkshopClient.Customer)(inValues[1]));
            return ((WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService)(this)).BeginAlreadySoldTo(employee, customer, callback, asyncState);
        }
        ...
        {
            if ((this.AlreadySoldToCompleted != null))
            {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.AlreadySoldToCompleted(this, new AlreadySoldToCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }

        public void AlreadySoldToAsync(WAQSWorkshopClient.Employee employee, WAQSWorkshopClient.Customer customer)
        {
            this.AlreadySoldToAsync(employee, customer, null);
        }

        public void AlreadySoldToAsync(WAQSWorkshopClient.Employee employee, WAQSWorkshopClient.Customer customer, object userState)
        {
            if ((this.onBeginAlreadySoldToDelegate == null))
            {
                this.onBeginAlreadySoldToDelegate = new BeginOperationDelegate(this.OnBeginAlreadySoldTo);
            }

            if ((this.onEndAlreadySoldToDelegate == null))
            {
                this.onEndAlreadySoldToDelegate = new EndOperationDelegate(this.OnEndAlreadySoldTo);
            }

            if ((this.onAlreadySoldToCompletedDelegate == null))
            {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.BeginAddInvoice(int orderId, System.AsyncCallback callback, object asyncState)
        {
            return base.Channel.BeginAddInvoice(orderId, callback, asyncState);
        }

        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WAQSWorkshopClient.Invoice WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.EndAddInvoice(System.IAsyncResult result)
        {
            return base.Channel.EndAddInvoice(result);
        }

        private System.IAsyncResult OnBeginAddInvoice(object[] inValues, System.AsyncCallback callback, object asyncState)
        {
            int orderId = ((int)(inValues[0]));
            return ((WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService)(this)).BeginAddInvoice(orderId, callback, asyncState);
        }

        private object[] OnEndAddInvoice(System.IAsyncResult result)
        {
            WAQSWorkshopClient.Invoice retVal = ((WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService)(this)).EndAddInvoice(result);
            return new object[]{retVal};
        }

        private void OnAddInvoiceCompleted(object state)
        {
            if ((this.AddInvoiceCompleted != null))
            {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.AddInvoiceCompleted(this, new AddInvoiceCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }

        public void AddInvoiceAsync(int orderId)
        {
            this.AddInvoiceAsync(orderId, null);
        }

        public void AddInvoiceAsync(int orderId, object userState)
        {
            if ((this.onBeginAddInvoiceDelegate == null))
            {
                this.onBeginAddInvoiceDelegate = new BeginOperationDelegate(this.OnBeginAddInvoice);
            }

            if ((this.onEndAddInvoiceDelegate == null))
            {
                this.onEndAddInvoiceDelegate = new EndOperationDelegate(this.OnEndAddInvoice);
            }

            if ((this.onAddInvoiceCompletedDelegate == null))
            {
                this.onAddInvoiceCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnAddInvoiceCompleted);
            }

            base.InvokeAsync(this.onBeginAddInvoiceDelegate, new object[]{orderId}, this.onEndAddInvoiceDelegate, this.onAddInvoiceCompletedDelegate, userState);
        }

        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.BeginCreateInvoiceDetail(WAQSWorkshopClient.OrderDetail od, System.AsyncCallback callback, object asyncState)
        {
            return base.Channel.BeginCreateInvoiceDetail(od, callback, asyncState);
        }

        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WAQSWorkshopClient.InvoiceDetail WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.EndCreateInvoiceDetail(System.IAsyncResult result)
        {
            return base.Channel.EndCreateInvoiceDetail(result);
        }

        private System.IAsyncResult OnBeginCreateInvoiceDetail(object[] inValues, System.AsyncCallback callback, object asyncState)
        {
            WAQSWorkshopClient.OrderDetail od = ((WAQSWorkshopClient.OrderDetail)(inValues[0]));
            return ((WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService)(this)).BeginCreateInvoiceDetail(od, callback, asyncState);
        }

        private object[] OnEndCreateInvoiceDetail(System.IAsyncResult result)
        {
            WAQSWorkshopClient.InvoiceDetail retVal = ((WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService)(this)).EndCreateInvoiceDetail(result);
            return new object[]{retVal};
        }

        private void OnCreateInvoiceDetailCompleted(object state)
        {
            if ((this.CreateInvoiceDetailCompleted != null))
            {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.CreateInvoiceDetailCompleted(this, new CreateInvoiceDetailCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }

        public void CreateInvoiceDetailAsync(WAQSWorkshopClient.OrderDetail od)
        {
            this.CreateInvoiceDetailAsync(od, null);
        }

        public void CreateInvoiceDetailAsync(WAQSWorkshopClient.OrderDetail od, object userState)
        {
            if ((this.onBeginCreateInvoiceDetailDelegate == null))
            {
                this.onBeginCreateInvoiceDetailDelegate = new BeginOperationDelegate(this.OnBeginCreateInvoiceDetail);
            }

            if ((this.onEndCreateInvoiceDetailDelegate == null))
            {
                this.onEndCreateInvoiceDetailDelegate = new EndOperationDelegate(this.OnEndCreateInvoiceDetail);
            }

            if ((this.onCreateInvoiceDetailCompletedDelegate == null))
            {
                this.onCreateInvoiceDetailCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnCreateInvoiceDetailCompleted);
            }

            base.InvokeAsync(this.onBeginCreateInvoiceDetailDelegate, new object[]{od}, this.onEndCreateInvoiceDetailDelegate, this.onCreateInvoiceDetailCompletedDelegate, userState);
        }

        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.BeginGetLastOrder(System.AsyncCallback callback, object asyncState)
        {
            return base.Channel.BeginGetLastOrder(callback, asyncState);
        }

        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WAQSWorkshopClient.DTO.LastOrderDTO WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService.EndGetLastOrder(System.IAsyncResult result)
        {
            return base.Channel.EndGetLastOrder(result);
        }

        private System.IAsyncResult OnBeginGetLastOrder(object[] inValues, System.AsyncCallback callback, object asyncState)
        {
            return ((WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService)(this)).BeginGetLastOrder(callback, asyncState);
        }

        private object[] OnEndGetLastOrder(System.IAsyncResult result)
        {
            WAQSWorkshopClient.DTO.LastOrderDTO retVal = ((WAQSWorkshopClient.ClientContext.ServiceReference.INorthwindService)(this)).EndGetLastOrder(result);
            return new object[]{retVal};
        }

        private void OnGetLastOrderCompleted(object state)
        {
            if ((this.GetLastOrderCompleted != null))
            {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.GetLastOrderCompleted(this, new GetLastOrderCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        ...
        {
            if ((this.onBeginGetLastOrderDelegate == null))
            {
                this.onBeginGetLastOrderDelegate = new BeginOperationDelegate(this.OnBeginGetLastOrder);
            }

            if ((this.onEndGetLastOrderDelegate == null))
            {
                this.onEndGetLastOrderDelegate = new EndOperationDelegate(this.OnEndGetLastOrder);
            }

            if ((this.onGetLastOrderCompletedDelegate == null))
            {
                this.onGetLastOrderCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnGetLastOrderCompleted);
            }

            base.InvokeAsync(this.onBeginGetLastOrderDelegate, null, this.onEndGetLastOrderDelegate, this.onGetLastOrderCompletedDelegate, userState);
        }
    }
}
