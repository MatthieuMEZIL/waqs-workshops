...
namespace WAQSWorkshopClient.ClientContext
{
    public partial class NorthwindClientContext : NorthwindClientContextBase, INorthwindClientContext, IClientContext
    {
        ...
        protected override WAQSWorkshopClient.DTO.LastOrderDTO GetDTO(WAQSWorkshopClient.DTO.LastOrderDTO dto, List<WAQSWorkshopClient.DTO.LastOrderDTO> attachedDtosLastOrderDTO, MergeOption? mergeOption = null, bool applyDataTransfer = false)
        {
            return GetDTO(dto, attachedDtosLastOrderDTO, false, mergeOption, ObjectState.Unchanged, applyDataTransfer);
        }
        ...
        {
            return GetDTO(dto, new List<WAQSWorkshopClient.DTO.LastOrderDTO>(), applyState, mergeOption, defaultState, applyDataTransfer);
        }
        private WAQSWorkshopClient.DTO.LastOrderDTO GetDTO(WAQSWorkshopClient.DTO.LastOrderDTO dto, List<WAQSWorkshopClient.DTO.LastOrderDTO> attachedDtosLastOrderDTO, bool applyState, MergeOption? mergeOption = null, ObjectState defaultState = ObjectState.Unchanged, bool applyDataTransfer = false)
        {
            if (dto == null)
                return null;
