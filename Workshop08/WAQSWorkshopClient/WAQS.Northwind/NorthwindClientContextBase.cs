            ...
            getEntity = (value, type) =>
                {
                    ...
                    if ((valueAsLastOrderDTO = (value as WAQSWorkshopClient.DTO.LastOrderDTO)) != null)
                        return GetDTO(valueAsLastOrderDTO, attachedDtosLastOrderDTO, mergeOption);
                    ...
                    if (valueAsLastOrderDTOs != null)
                    {
                        ...
                        if (ctor != null)
                            return ctor.Invoke(new object[] { valueAsLastOrderDTOs.Select(e => GetDTO(e, attachedDtosLastOrderDTO, mergeOption)) });
                        valueAsLastOrderDTOs = valueAsLastOrderDTOs.Select(e => GetDTO(e, attachedDtosLastOrderDTO, mergeOption));
                        if (type.IsArray)
