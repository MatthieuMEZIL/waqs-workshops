...
#region Simple Properties
        ...
        protected virtual Error ValidateQuantityPerUnitMaxLength(string value)
        {
            ...
            if (error == null)
                Errors.QuantityPerUnit.Add(error = new Error{Criticity = Criticity.Error, Key = "QuantityPerUnitMaxLength", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
...
#region Navigation Properties
        ...
        private void CategoryAddHandler(Category entity)
        {
            if (entity != null)
            {
                entity.PropertyChanged += CategoryPropertyChanged;
            }
        }
        ...
        private void CategoryRemoveHandler(Category entity)
        {
            if (entity != null)
            {
                entity.PropertyChanged -= CategoryPropertyChanged;
        ...
        protected virtual void OnCategoryChanged(Category oldValue, Category newValue, bool raise = true, bool validate = true)
        {
            CategoryRemoveHandler(oldValue);
            CategoryAddHandler(newValue);
            if (raise)
        ...
        public Category Category
        {
            ...
            set
            {
                ...
                OnCategoryChanged(oldCategory, _category, raise: IsInitializingRelationships);
...
#region Specifications
        ...
        private ProductSpecifications _specifications;
        [DataMember]
...
#region UISpecifications
        static Product()
        {
            ...
            DynamicType<Product>.AddProperty("FullNameErrors", e => e.Errors.FullName);
            StaticInitializer();
        }
