...
#region Simple Properties
        ...
        protected virtual void OnLastNameChanged(bool raise = true, bool validate = true)
        {
            if (raise)
        ...
        public string LastName
        {
            ...
            set
            {
                ...
                if (!ChangeTracker.Saving)
                {
                    ...
                    OnLastNameChanged(validate: !IsDeserializing);
                }
            }
        }
        ...
        protected virtual Error ValidateLastNameRequired(string value)
        {
            ...
            if (error == null)
                Errors.LastName.Add(error = new Error{Criticity = Criticity.Mandatory, Key = "LastNameRequired", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
        ...
        protected virtual Error ValidateLastNameMaxLength(string value)
        {
            ...
            if (error == null)
                Errors.LastName.Add(error = new Error{Criticity = Criticity.Error, Key = "LastNameMaxLength", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }

        protected virtual void OnFirstNameChanged(bool raise = true, bool validate = true)
        {
            if (raise)
        ...
        public string FirstName
        {
            ...
            set
            {
                ...
                if (!ChangeTracker.Saving)
                {
                    ...
                    OnFirstNameChanged(validate: !IsDeserializing);
                }
            }
        }
        ...
        protected virtual Error ValidateFirstNameRequired(string value)
        {
            ...
            if (error == null)
                Errors.FirstName.Add(error = new Error{Criticity = Criticity.Mandatory, Key = "FirstNameRequired", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
        ...
        protected virtual Error ValidateFirstNameMaxLength(string value)
        {
            ...
            if (error == null)
                Errors.FirstName.Add(error = new Error{Criticity = Criticity.Error, Key = "FirstNameMaxLength", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
        ...
        protected virtual Error ValidateTitleMaxLength(string value)
        {
            ...
            if (error == null)
                Errors.Title.Add(error = new Error{Criticity = Criticity.Error, Key = "TitleMaxLength", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
        ...
        protected virtual Error ValidateTitleOfCourtesyMaxLength(string value)
        {
            ...
            if (error == null)
                Errors.TitleOfCourtesy.Add(error = new Error{Criticity = Criticity.Error, Key = "TitleOfCourtesyMaxLength", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
        ...
        protected virtual Error ValidateHomePhoneMaxLength(string value)
        {
            ...
            if (error == null)
                Errors.HomePhone.Add(error = new Error{Criticity = Criticity.Error, Key = "HomePhoneMaxLength", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
        ...
        protected virtual Error ValidateExtensionMaxLength(string value)
        {
            ...
            if (error == null)
                Errors.Extension.Add(error = new Error{Criticity = Criticity.Error, Key = "ExtensionMaxLength", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
        ...
        protected virtual Error ValidatePhotoPathMaxLength(string value)
        {
            ...
            if (error == null)
                Errors.PhotoPath.Add(error = new Error{Criticity = Criticity.Error, Key = "PhotoPathMaxLength", Message = errorInfo.Message, ErrorInfo = errorInfo});
            return error;
        }
...
#region Specifications
        ...
        private EmployeeSpecifications _specifications;
        [DataMember]
...
#region UISpecifications
        static Employee()
        {
            ...
            DynamicType<Employee>.AddProperty("FullNameErrors", e => e.Errors.FullName);
            StaticInitializer();
        }
